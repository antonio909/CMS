...
<head>
  ...
  <style>
    ...
    h1,h2,h3,h4,h5,h6 {margin: 2em 0 .6em 0; letter-spacing: -0.01em; line-height: normal; font-weight: bold; text-rendering: optimizeLegibility;}
    h1 { font-size: 24px; }
    h2 { font-size: 22px; }
    h3 { font-size: 20px; }
    h4 { font-size: 18px; }
...
<body>
  <div class="top"><a href="/">Homepage</a> / [full-link]{title}[/full-link]</div>
  <h1 class="title">{title}</h1>
  <div class="text">{full-story}</div>
