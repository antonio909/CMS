  ...
  <div class="wrp">
    <h4 class="vote_line_title ultrabold">
      ...
      <span class="vote_icon">
        <i class="i1"></i><i class="i2"></i><i class="i3"></i><i class="14"></i>
      </span>
    </h4>
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-form">
          ...
          [votelist]
              ...
              <button title="Results" class="btn btn_border wide" type="button" onclick="doVote('results'); return false;"><b class="ultrabold">Results</b></button>
            </form>
          [/votelist]
        </div>
      </div>
